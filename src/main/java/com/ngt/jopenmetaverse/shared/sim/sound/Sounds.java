 ...
 */
package com.ngt.jopenmetaverse.shared.sim.sound;
...
import com.ngt.jopenmetaverse.shared.types.UUID;
  /// <summary>
    ...
    public class Sounds
    {
        ...
        public static Map<UUID, String> ToDictionary() throws IllegalArgumentException, IllegalAccessException
        {
...
//             Type type = typeof(Animations);
             ...
             for (Field field : flds)
             {
                     ...
                     {
                             dict.put((UUID)field.get(new Sounds()), field.getName());
                     }
             }
             return dict;
        }
