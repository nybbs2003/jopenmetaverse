...
{
	private  EnumSet<ScriptControlChange> m_Controls;
	...
	public EnumSet<ScriptControlChange> getControls() {return m_Controls;}
	...
	public ScriptControlEventArgs(EnumSet<ScriptControlChange> controls, boolean pass, boolean take)
	{
		m_Controls = controls;
		m_Pass = pass;
		m_Take = take;
