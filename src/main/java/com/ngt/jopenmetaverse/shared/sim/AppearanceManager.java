...
//				            AppearanceThread.start();
			...
			//
				        ...
				        private boolean DownloadWearables()
				        {
				            ...
				            int pendingWearables = wearables.size();
...
//				                                    {
//				                                        DecodeWearableParams(wearable);
//				                                        JLogger.debug("Downloaded wearable asset " + wearable.WearableType + " with " + wearable.Asset.Params.Count +
...
//				                                    {
//				                                        wearable.Asset = null;
//				                                        JLogger.debug("Failed to decode asset:" + Environment.NewLine +
//				                                            Utils.BytesToString(asset.AssetData), Helpers.LogLevel.Error, Client);
//				                                    }
//				                                }
//				                                else
//				                                {
//				                                    JLogger.debug("Wearable " + wearable.AssetID + "(" + wearable.WearableType + ") failed to download, " +
