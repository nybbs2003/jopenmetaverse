...
import com.ngt.jopenmetaverse.shared.types.UUID;
    ...
    public final class ClassifiedInfoRequestPacket extends Packet
    {
        ...
        public ClassifiedInfoRequestPacket(byte[] bytes, int[] i) throws MalformedDataException 
		{
		this();
        ...
        public ClassifiedInfoRequestPacket(Header head, byte[] bytes, int[] i) throws MalformedDataException
		{
		this();
            int[] packetEnd = new int[] {bytes.length - 1};
