...
import com.ngt.jopenmetaverse.shared.util.Utils;
	public final class SaveAssetIntoInventoryPacket extends Packet
    {
        ...
        public static final class InventoryDataBlock extends PacketBlock
        {
            ...
            public UUID NewAssetID = new UUID();
        ...
        public SaveAssetIntoInventoryPacket(byte[] bytes, int[] i) throws MalformedDataException 
		{
		this();
        ...
        public SaveAssetIntoInventoryPacket(Header head, byte[] bytes, int[] i) throws MalformedDataException
		{
		this();
            int[] packetEnd = new int[] {bytes.length - 1};
