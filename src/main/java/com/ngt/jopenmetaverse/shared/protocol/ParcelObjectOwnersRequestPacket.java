...
import com.ngt.jopenmetaverse.shared.util.Utils;
    ...
    public final class ParcelObjectOwnersRequestPacket extends Packet
    {
        ...
        public ParcelObjectOwnersRequestPacket(byte[] bytes, int[] i) throws MalformedDataException 
		{
		this();
        ...
        public ParcelObjectOwnersRequestPacket(Header head, byte[] bytes, int[] i) throws MalformedDataException
		{
		this();
            int[] packetEnd = new int[] {bytes.length - 1};
