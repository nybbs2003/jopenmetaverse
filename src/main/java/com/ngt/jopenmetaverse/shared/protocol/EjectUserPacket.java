...
import com.ngt.jopenmetaverse.shared.util.Utils;
    ...
    public final class EjectUserPacket extends Packet
    {
        ...
        public EjectUserPacket(byte[] bytes, int[] i) throws MalformedDataException 
		{
		this();
        ...
        public EjectUserPacket(Header head, byte[] bytes, int[] i) throws MalformedDataException
		{
		this();
            int[] packetEnd = new int[] {bytes.length - 1};
