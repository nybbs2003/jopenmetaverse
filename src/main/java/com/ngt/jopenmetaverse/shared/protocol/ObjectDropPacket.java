...
import com.ngt.jopenmetaverse.shared.util.Utils;
	public final class ObjectDropPacket extends Packet
    {
        ...
        public ObjectDropPacket(byte[] bytes, int[] i) throws MalformedDataException 
		{
		this();
        ...
        public ObjectDropPacket(Header head, byte[] bytes, int[] i) throws MalformedDataException
		{
		this();
            int[] packetEnd = new int[] {bytes.length - 1};
