...
import com.ngt.jopenmetaverse.shared.types.UUID;
    ...
    public final class AvatarPropertiesRequestPacket extends Packet
    {
        ...
        public AvatarPropertiesRequestPacket(byte[] bytes, int[] i) throws MalformedDataException 
		{
		this();
        ...
        public AvatarPropertiesRequestPacket(Header head, byte[] bytes, int[] i) throws MalformedDataException
		{
		this();
            int[] packetEnd = new int[] {bytes.length - 1};
