...
import com.ngt.jopenmetaverse.shared.util.Utils;
    ...
    public final class ParcelDwellRequestPacket extends Packet
    {
        ...
        public ParcelDwellRequestPacket(byte[] bytes, int[] i) throws MalformedDataException 
		{
		this();
        ...
        public ParcelDwellRequestPacket(Header head, byte[] bytes, int[] i) throws MalformedDataException
		{
		this();
            int[] packetEnd = new int[] {bytes.length - 1};
