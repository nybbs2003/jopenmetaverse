...
import com.ngt.jopenmetaverse.shared.util.Utils;
	public final class ObjectGroupPacket extends Packet
    {
        ...
        public ObjectGroupPacket(byte[] bytes, int[] i) throws MalformedDataException 
		{
		this();
        ...
        public ObjectGroupPacket(Header head, byte[] bytes, int[] i) throws MalformedDataException
		{
		this();
            int[] packetEnd = new int[] {bytes.length - 1};
