...
import com.ngt.jopenmetaverse.shared.util.Utils;
	public final class UpdateGroupInfoPacket extends Packet
    {
        ...
        public UpdateGroupInfoPacket(byte[] bytes, int[] i) throws MalformedDataException 
		{
		this();
        ...
        public UpdateGroupInfoPacket(Header head, byte[] bytes, int[] i) throws MalformedDataException
		{
		this();
            int[] packetEnd = new int[] {bytes.length - 1};
