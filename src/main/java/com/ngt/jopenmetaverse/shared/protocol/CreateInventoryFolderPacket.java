...
import com.ngt.jopenmetaverse.shared.util.Utils;
    ...
    public final class CreateInventoryFolderPacket extends Packet
    {
        ...
        public CreateInventoryFolderPacket(byte[] bytes, int[] i) throws MalformedDataException 
		{
		this();
        ...
        public CreateInventoryFolderPacket(Header head, byte[] bytes, int[] i) throws MalformedDataException
		{
		this();
            int[] packetEnd = new int[] {bytes.length - 1};
