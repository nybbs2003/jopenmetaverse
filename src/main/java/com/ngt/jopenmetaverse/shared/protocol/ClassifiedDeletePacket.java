...
import com.ngt.jopenmetaverse.shared.types.UUID;
    ...
    public final class ClassifiedDeletePacket extends Packet
    {
        ...
        public ClassifiedDeletePacket(byte[] bytes, int[] i) throws MalformedDataException 
		{
		this();
        ...
        public ClassifiedDeletePacket(Header head, byte[] bytes, int[] i) throws MalformedDataException
		{
		this();
            int[] packetEnd = new int[] {bytes.length - 1};
