...
import com.ngt.jopenmetaverse.shared.util.Utils;
	public final class ObjectNamePacket extends Packet
    {
        ...
        public ObjectNamePacket(byte[] bytes, int[] i) throws MalformedDataException 
		{
		this();
        ...
        public ObjectNamePacket(Header head, byte[] bytes, int[] i) throws MalformedDataException
		{
		this();
            int[] packetEnd = new int[] {bytes.length - 1};
