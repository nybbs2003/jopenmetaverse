...
import com.ngt.jopenmetaverse.shared.util.Utils;
	public final class TeleportStartPacket extends Packet
    {
        ...
        public TeleportStartPacket(byte[] bytes, int[] i) throws MalformedDataException 
		{
		this();
        ...
        public TeleportStartPacket(Header head, byte[] bytes, int[] i) throws MalformedDataException
		{
		this();
            int[] packetEnd = new int[] {bytes.length - 1};
