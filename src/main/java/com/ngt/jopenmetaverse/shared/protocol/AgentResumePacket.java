...
import com.ngt.jopenmetaverse.shared.util.Utils;
    ...
    public final class AgentResumePacket extends Packet
    {
        ...
        public AgentResumePacket(byte[] bytes, int[] i) throws MalformedDataException 
		{
		this();
        ...
        public AgentResumePacket(Header head, byte[] bytes, int[] i) throws MalformedDataException
		{
		this();
            int[] packetEnd = new int[] {bytes.length - 1};
