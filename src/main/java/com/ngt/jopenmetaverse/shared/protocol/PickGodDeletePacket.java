...
import com.ngt.jopenmetaverse.shared.types.UUID;
    ...
    public final class PickGodDeletePacket extends Packet
    {
        ...
        public PickGodDeletePacket(byte[] bytes, int[] i) throws MalformedDataException 
		{
		this();
        ...
        public PickGodDeletePacket(Header head, byte[] bytes, int[] i) throws MalformedDataException
		{
		this();
            int[] packetEnd = new int[] {bytes.length - 1};
