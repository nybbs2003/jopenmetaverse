...
import com.ngt.jopenmetaverse.shared.util.Utils;
    ...
    public final class DirLandReplyPacket extends Packet
    {
        ...
        public DirLandReplyPacket(byte[] bytes, int[] i) throws MalformedDataException 
		{
		this();
        ...
        public DirLandReplyPacket(Header head, byte[] bytes, int[] i) throws MalformedDataException
		{
		this();
            int[] packetEnd = new int[] {bytes.length - 1};
