...
import com.ngt.jopenmetaverse.shared.util.Utils;
	public final class ObjectExtraParamsPacket extends Packet
    {
        ...
        public ObjectExtraParamsPacket(byte[] bytes, int[] i) throws MalformedDataException 
		{
		this();
        ...
        public ObjectExtraParamsPacket(Header head, byte[] bytes, int[] i) throws MalformedDataException
		{
		this();
            int[] packetEnd = new int[] {bytes.length - 1};
