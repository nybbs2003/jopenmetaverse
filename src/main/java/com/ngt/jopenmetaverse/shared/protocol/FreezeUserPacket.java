...
import com.ngt.jopenmetaverse.shared.util.Utils;
    ...
    public final class FreezeUserPacket extends Packet
    {
        ...
        public FreezeUserPacket(byte[] bytes, int[] i) throws MalformedDataException 
		{
		this();
        ...
        public FreezeUserPacket(Header head, byte[] bytes, int[] i) throws MalformedDataException
		{
		this();
            int[] packetEnd = new int[] {bytes.length - 1};
