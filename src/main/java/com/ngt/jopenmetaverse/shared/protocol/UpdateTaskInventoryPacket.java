...
import com.ngt.jopenmetaverse.shared.util.Utils;
	public final class UpdateTaskInventoryPacket extends Packet
    {
        ...
        /// <exclude/>
        public static final class UpdateDataBlock extends PacketBlock
        {
            public long LocalID;
		/** Unsigned Byte */ 
		public byte Key;
        ...
        public UpdateTaskInventoryPacket(byte[] bytes, int[] i) throws MalformedDataException 
		{
		this();
        ...
        public UpdateTaskInventoryPacket(Header head, byte[] bytes, int[] i) throws MalformedDataException
		{
		this();
            int[] packetEnd = new int[] {bytes.length - 1};
