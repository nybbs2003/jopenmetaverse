...
import com.ngt.jopenmetaverse.shared.util.Utils;
	public final class RevokePermissionsPacket extends Packet
    {
        ...
        public RevokePermissionsPacket(byte[] bytes, int[] i) throws MalformedDataException 
		{
		this();
        ...
        public RevokePermissionsPacket(Header head, byte[] bytes, int[] i) throws MalformedDataException
		{
		this();
            int[] packetEnd = new int[] {bytes.length - 1};
