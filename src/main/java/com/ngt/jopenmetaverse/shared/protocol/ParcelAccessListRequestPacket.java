...
import com.ngt.jopenmetaverse.shared.util.Utils;
	public final class ParcelAccessListRequestPacket extends Packet
    {
        ...
        public ParcelAccessListRequestPacket(byte[] bytes, int[] i) throws MalformedDataException 
		{
		this();
        ...
        public ParcelAccessListRequestPacket(Header head, byte[] bytes, int[] i) throws MalformedDataException
		{
		this();
            int[] packetEnd = new int[] {bytes.length - 1};
