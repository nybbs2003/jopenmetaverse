...
import com.ngt.jopenmetaverse.shared.util.Utils;
	public final class UpdateUserInfoPacket extends Packet
    {
        ...
        public final class UserDataBlock extends PacketBlock
        {
            ...
            public UserDataBlock(byte[] bytes, int[] i) throws MalformedDataException
            {
                FromBytes(bytes, i);
            }
        ...
        public UpdateUserInfoPacket(byte[] bytes, int[] i) throws MalformedDataException 
		{
		this();
        ...
        public UpdateUserInfoPacket(Header head, byte[] bytes, int[] i) throws MalformedDataException
		{
		this();
            int[] packetEnd = new int[] {bytes.length - 1};
