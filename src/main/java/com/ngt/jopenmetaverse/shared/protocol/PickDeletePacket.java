...
import com.ngt.jopenmetaverse.shared.types.UUID;
    ...
    public final class PickDeletePacket extends Packet
    {
        ...
        public PickDeletePacket(byte[] bytes, int[] i) throws MalformedDataException 
		{
		this();
        ...
        public PickDeletePacket(Header head, byte[] bytes, int[] i) throws MalformedDataException
		{
		this();
            int[] packetEnd = new int[] {bytes.length - 1};
