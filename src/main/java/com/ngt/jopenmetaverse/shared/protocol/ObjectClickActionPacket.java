...
import com.ngt.jopenmetaverse.shared.util.Utils;
	public final class ObjectClickActionPacket extends Packet
    {
        ...
        public ObjectClickActionPacket(byte[] bytes, int[] i) throws MalformedDataException 
		{
		this();
        ...
        public ObjectClickActionPacket(Header head, byte[] bytes, int[] i) throws MalformedDataException
		{
		this();
            int[] packetEnd = new int[] {bytes.length - 1};
