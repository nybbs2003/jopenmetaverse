...
import com.ngt.jopenmetaverse.shared.util.Utils;
    ...
    public final class ParcelSetOtherCleanTimePacket extends Packet
    {
        ...
        public ParcelSetOtherCleanTimePacket(byte[] bytes, int[] i) throws MalformedDataException 
		{
		this();
        ...
        public ParcelSetOtherCleanTimePacket(Header head, byte[] bytes, int[] i) throws MalformedDataException
		{
		this();
            int[] packetEnd = new int[] {bytes.length - 1};
