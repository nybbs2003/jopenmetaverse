...
import com.ngt.jopenmetaverse.shared.util.Utils;
    ...
    public final class AcceptFriendshipPacket extends Packet
    {
        ...
        public AcceptFriendshipPacket(byte[] bytes, int[] i) throws MalformedDataException 
		{
		this();
        ...
        public AcceptFriendshipPacket(Header head, byte[] bytes, int[] i) throws MalformedDataException
		{
		this();
            int[] packetEnd = new int[] {bytes.length - 1};
