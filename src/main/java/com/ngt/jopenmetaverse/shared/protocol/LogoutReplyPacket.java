...
import com.ngt.jopenmetaverse.shared.util.Utils;
	public final class LogoutReplyPacket extends Packet
    {
        ...
        public LogoutReplyPacket(byte[] bytes, int[] i) throws MalformedDataException 
		{
		this();
        ...
        public LogoutReplyPacket(Header head, byte[] bytes, int[] i) throws MalformedDataException
		{
		this();
            int[] packetEnd = new int[] {bytes.length - 1};
