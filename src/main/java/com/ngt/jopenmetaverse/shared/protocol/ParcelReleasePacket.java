...
import com.ngt.jopenmetaverse.shared.util.Utils;
    ...
    public final class ParcelReleasePacket extends Packet
    {
        ...
        public ParcelReleasePacket(byte[] bytes, int[] i) throws MalformedDataException 
		{
		this();
        ...
        public ParcelReleasePacket(Header head, byte[] bytes, int[] i) throws MalformedDataException
		{
		this();
            int[] packetEnd = new int[] {bytes.length - 1};
