...
import com.ngt.jopenmetaverse.shared.util.Utils;
	public final class ScriptDialogReplyPacket extends Packet
    {
        ...
        public ScriptDialogReplyPacket(byte[] bytes, int[] i) throws MalformedDataException 
		{
		this();
        ...
        public ScriptDialogReplyPacket(Header head, byte[] bytes, int[] i) throws MalformedDataException
		{
		this();
            int[] packetEnd = new int[] {bytes.length - 1};
