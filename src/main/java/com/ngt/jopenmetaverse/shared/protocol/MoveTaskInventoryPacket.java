...
import com.ngt.jopenmetaverse.shared.util.Utils;
	public final class MoveTaskInventoryPacket extends Packet
    {
        ...
        public MoveTaskInventoryPacket(byte[] bytes, int[] i) throws MalformedDataException 
		{
		this();
        ...
        public MoveTaskInventoryPacket(Header head, byte[] bytes, int[] i) throws MalformedDataException
		{
		this();
            int[] packetEnd = new int[] {bytes.length - 1};
