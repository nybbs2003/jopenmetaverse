...
import com.ngt.jopenmetaverse.shared.util.Utils;
    ...
    public final class ParcelGodForceOwnerPacket extends Packet
    {
        ...
        public ParcelGodForceOwnerPacket(byte[] bytes, int[] i) throws MalformedDataException 
		{
		this();
        ...
        public ParcelGodForceOwnerPacket(Header head, byte[] bytes, int[] i) throws MalformedDataException
		{
		this();
            int[] packetEnd = new int[] {bytes.length - 1};
