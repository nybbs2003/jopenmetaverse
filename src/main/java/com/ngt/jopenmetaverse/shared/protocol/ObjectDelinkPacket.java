...
import com.ngt.jopenmetaverse.shared.util.Utils;
	public final class ObjectDelinkPacket extends Packet
    {
        ...
        public ObjectDelinkPacket(byte[] bytes, int[] i) throws MalformedDataException 
		{
		this();
        ...
        public ObjectDelinkPacket(Header head, byte[] bytes, int[] i) throws MalformedDataException
		{
		this();
            int[] packetEnd = new int[] {bytes.length - 1};
