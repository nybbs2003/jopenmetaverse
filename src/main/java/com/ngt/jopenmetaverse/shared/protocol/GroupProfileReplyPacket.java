        ...
        public final class GroupDataBlock extends PacketBlock
        {
			...
			public void FromBytes(byte[] bytes, int[] i) throws MalformedDataException
            {
                ...
                try
                {
                    ...
                    PowersMask = Utils.bytesToULong(bytes, i[0]); i[0] += 8;
                    ...
                    Money = Utils.bytesToInt(bytes, i[0]); i[0]+=4;
                    GroupMembershipCount = Utils.bytesToInt(bytes, i[0]); i[0]+=4;
                    GroupRolesCount = Utils.bytesToInt(bytes, i[0]); i[0]+=4;
			...
			public void ToBytes(byte[] bytes, int[] i)
            {
                ...
                Utils.ulongToBytes(PowersMask, bytes, i[0]); i[0] += 8;
                ...
                Utils.intToBytes(Money, bytes, i[0]); i[0] += 4;
                Utils.intToBytes(GroupMembershipCount, bytes, i[0]); i[0] += 4;
                Utils.intToBytes(GroupRolesCount, bytes, i[0]); i[0] += 4;
