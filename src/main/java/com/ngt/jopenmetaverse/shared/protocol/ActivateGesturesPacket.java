...
import com.ngt.jopenmetaverse.shared.util.Utils;
    ...
    public final class ActivateGesturesPacket extends Packet
    {
        ...
        public final class AgentDataBlock extends PacketBlock
        {
			...
			public void FromBytes(byte[] bytes, int[] i) throws MalformedDataException
            {
                try
                {
                    ...
                    Flags = ((long)bytes[i[0]++] + ((long)bytes[i[0]++] << 8) + ((long)bytes[i[0]++] << 16) + ((long)bytes[i[0]++] << 24));
                }
                catch (Exception e)
                {
        ...
        public final class DataBlock extends PacketBlock
        {
			...
			public void FromBytes(byte[] bytes, int[] i) throws MalformedDataException
            {
                try
                {
                    ...
                    GestureFlags = ((long)bytes[i[0]++] + ((long)bytes[i[0]++] << 8) + ((long)bytes[i[0]++] << 16) + ((long)bytes[i[0]++] << 24));
                }
                catch (Exception e)
                {
                    throw new MalformedDataException();
        ...
        public ActivateGesturesPacket(byte[] bytes, int[] i) throws MalformedDataException 
		{
		this();
        ...
        public ActivateGesturesPacket(Header head, byte[] bytes, int[] i) throws MalformedDataException
		{
		this();
            int[] packetEnd = new int[] {bytes.length - 1};
