...
import com.ngt.jopenmetaverse.shared.util.Utils;
	public final class SetGroupContributionPacket extends Packet
    {
        ...
        public SetGroupContributionPacket(byte[] bytes, int[] i) throws MalformedDataException 
		{
		this();
        ...
        public SetGroupContributionPacket(Header head, byte[] bytes, int[] i) throws MalformedDataException
		{
		this();
            int[] packetEnd = new int[] {bytes.length - 1};
