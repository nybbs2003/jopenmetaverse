...
import com.ngt.jopenmetaverse.shared.util.Utils;
	public final class GroupRoleMembersRequestPacket extends Packet
    {
        ...
        public GroupRoleMembersRequestPacket(byte[] bytes, int[] i) throws MalformedDataException 
		{
		this();
        ...
        public GroupRoleMembersRequestPacket(Header head, byte[] bytes, int[] i) throws MalformedDataException
		{
		this();
            int[] packetEnd = new int[] {bytes.length - 1};
