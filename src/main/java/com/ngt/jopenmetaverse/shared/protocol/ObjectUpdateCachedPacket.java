...
import com.ngt.jopenmetaverse.shared.util.Utils;
	public final class ObjectUpdateCachedPacket extends Packet
    {
        ...
        public ObjectUpdateCachedPacket(byte[] bytes, int[] i) throws MalformedDataException 
		{
		this();
        ...
        public ObjectUpdateCachedPacket(Header head, byte[] bytes, int[] i) throws MalformedDataException
		{
		this();
            int[] packetEnd = new int[] {bytes.length - 1};
