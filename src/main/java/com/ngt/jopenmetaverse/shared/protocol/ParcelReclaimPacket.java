...
import com.ngt.jopenmetaverse.shared.util.Utils;
    ...
    public final class ParcelReclaimPacket extends Packet
    {
        ...
        public ParcelReclaimPacket(byte[] bytes, int[] i) throws MalformedDataException 
		{
		this();
        ...
        public ParcelReclaimPacket(Header head, byte[] bytes, int[] i) throws MalformedDataException
		{
		this();
            int[] packetEnd = new int[] {bytes.length - 1};
