...
import com.ngt.jopenmetaverse.shared.util.Utils;
	public final class ObjectLinkPacket extends Packet
    {
        ...
        public ObjectLinkPacket(byte[] bytes, int[] i) throws MalformedDataException 
		{
		this();
        ...
        public ObjectLinkPacket(Header head, byte[] bytes, int[] i) throws MalformedDataException
		{
		this();
            int[] packetEnd = new int[] {bytes.length - 1};
