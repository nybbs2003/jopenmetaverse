package com.ngt.jopenmetaverse.shared.protocol;
    ...
    public final class ObjectImagePacket extends Packet
    {
        ...
        public ObjectImagePacket(byte[] bytes, int[] i) throws MalformedDataException 
		{
		this();
        ...
        public ObjectImagePacket(Header head, byte[] bytes, int[] i) throws MalformedDataException
		{
		this();
            int[] packetEnd = new int[] {bytes.length - 1};
