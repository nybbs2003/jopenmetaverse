...
import com.ngt.jopenmetaverse.shared.util.Utils;
	public final class ObjectDeselectPacket extends Packet
    {
        ...
        public ObjectDeselectPacket(byte[] bytes, int[] i) throws MalformedDataException 
		{
		this();
        ...
        public ObjectDeselectPacket(Header head, byte[] bytes, int[] i) throws MalformedDataException
		{
		this();
            int[] packetEnd = new int[] {bytes.length - 1};
