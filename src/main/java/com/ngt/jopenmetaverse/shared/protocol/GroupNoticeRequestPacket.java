...
import com.ngt.jopenmetaverse.shared.util.Utils;
	public final class GroupNoticeRequestPacket extends Packet
    {
        ...
        {
            public UUID GroupNoticeID = new UUID();
        ...
        public GroupNoticeRequestPacket(byte[] bytes, int[] i) throws MalformedDataException 
		{
		this();
        ...
        public GroupNoticeRequestPacket(Header head, byte[] bytes, int[] i) throws MalformedDataException
		{
		this();
            int[] packetEnd = new int[] {bytes.length - 1};
