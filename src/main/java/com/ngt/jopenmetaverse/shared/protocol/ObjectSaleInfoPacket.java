...
import com.ngt.jopenmetaverse.shared.util.Utils;
	public final class ObjectSaleInfoPacket extends Packet
    {
        ...
        public ObjectSaleInfoPacket(byte[] bytes, int[] i) throws MalformedDataException 
		{
		this();
        ...
        public ObjectSaleInfoPacket(Header head, byte[] bytes, int[] i) throws MalformedDataException
		{
		this();
            int[] packetEnd = new int[] {bytes.length - 1};
