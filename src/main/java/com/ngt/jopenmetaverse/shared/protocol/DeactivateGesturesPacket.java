...
import com.ngt.jopenmetaverse.shared.util.Utils;
    ...
    public final class DeactivateGesturesPacket extends Packet
    {
        ...
        public DeactivateGesturesPacket(byte[] bytes, int[] i) throws MalformedDataException 
		{
		this();
        ...
        public DeactivateGesturesPacket(Header head, byte[] bytes, int[] i) throws MalformedDataException
		{
		this();
            int[] packetEnd = new int[] {bytes.length - 1};
