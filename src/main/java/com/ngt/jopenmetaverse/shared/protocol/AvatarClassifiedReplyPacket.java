...
import com.ngt.jopenmetaverse.shared.util.Utils;
    ...
    public final class AvatarClassifiedReplyPacket extends Packet
    {
        ...
        public AvatarClassifiedReplyPacket(byte[] bytes, int[] i) throws MalformedDataException 
		{
		this();
        ...
        public AvatarClassifiedReplyPacket(Header head, byte[] bytes, int[] i) throws MalformedDataException
		{
		this();
            int[] packetEnd = new int[] {bytes.length - 1};
