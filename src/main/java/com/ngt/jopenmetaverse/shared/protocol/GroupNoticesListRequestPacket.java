...
import com.ngt.jopenmetaverse.shared.util.Utils;
	public final class GroupNoticesListRequestPacket extends Packet
    {
        ...
        public GroupNoticesListRequestPacket(byte[] bytes, int[] i) throws MalformedDataException 
		{
		this();
        ...
        public GroupNoticesListRequestPacket(Header head, byte[] bytes, int[] i) throws MalformedDataException
		{
		this();
            int[] packetEnd = new int[] {bytes.length - 1};
