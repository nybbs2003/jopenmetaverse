...
import com.ngt.jopenmetaverse.shared.util.Utils;
	public final class InventoryDescendentsPacket extends Packet
    {
        ...
        public static final class AgentDataBlock extends PacketBlock
        {
			...
			public void FromBytes(byte[] bytes, int[] i) throws MalformedDataException
            {
                try
                {
                    ...
                    Version = Utils.bytesToIntLit(bytes, i[0]); i[0]+=4;
                    Descendents = Utils.bytesToIntLit(bytes, i[0]); i[0]+=4;
                }
                catch (Exception e)
                {
			...
			public void ToBytes(byte[] bytes, int[] i)
            {
                ...
                Utils.intToBytesLit(Version, bytes, i[0]); i[0] += 4;
                Utils.intToBytesLit(Descendents, bytes, i[0]); i[0] += 4;
            }
        ...
        public InventoryDescendentsPacket(byte[] bytes, int[] i) throws MalformedDataException 
		{
		this();
        ...
        public InventoryDescendentsPacket(Header head, byte[] bytes, int[] i) throws MalformedDataException
		{
		this();
            int[] packetEnd = new int[] {bytes.length - 1};
