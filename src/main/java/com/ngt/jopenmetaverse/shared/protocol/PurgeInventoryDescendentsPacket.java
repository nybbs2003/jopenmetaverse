...
import com.ngt.jopenmetaverse.shared.util.Utils;
	public final class PurgeInventoryDescendentsPacket extends Packet
    {
        ...
        public PurgeInventoryDescendentsPacket(byte[] bytes, int[] i) throws MalformedDataException 
		{
		this();
        ...
        public PurgeInventoryDescendentsPacket(Header head, byte[] bytes, int[] i) throws MalformedDataException
		{
		this();
            int[] packetEnd = new int[] {bytes.length - 1};
