...
import com.ngt.jopenmetaverse.shared.util.Utils;
	public final class GroupTitlesRequestPacket extends Packet
    {
        ...
        public GroupTitlesRequestPacket(byte[] bytes, int[] i) throws MalformedDataException 
		{
		this();
        ...
        public GroupTitlesRequestPacket(Header head, byte[] bytes, int[] i) throws MalformedDataException
		{
		this();
            int[] packetEnd = new int[] {bytes.length - 1};
