...
import com.ngt.jopenmetaverse.shared.util.Utils;
	public final class ObjectMaterialPacket extends Packet
    {
        ...
        public ObjectMaterialPacket(byte[] bytes, int[] i) throws MalformedDataException 
		{
		this();
        ...
        public ObjectMaterialPacket(Header head, byte[] bytes, int[] i) throws MalformedDataException
		{
		this();
            int[] packetEnd = new int[] {bytes.length - 1};
